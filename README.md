...
- `MANGAMAKER_AGENT_MAX_OUTPUT_TOKENS` can raise or lower the model response budget; the default is `8192`. `MANGAMAKER_AGENT_TEMPERATURE` defaults to `0.1`, and `MANGAMAKER_AGENT_TOP_P` defaults to `0.9` for low-variance JSON/tool behavior.
